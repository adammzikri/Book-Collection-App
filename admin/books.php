						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								//if(isset($_GET['year']) && $_GET['year'] != ''){
									...
									//$book = $conn->query("SELECT * FROM books WHERE year='$year' ORDER BY id DESC");

								//}
								$i = 1;
								$cname[0] = "Not Set";
								$author = $conn->query("SELECT * FROM authors ");
								...
								<tr>
									...
									<td class="">
										...
										<p><small>Year: <b class="truncate"><?php echo $row['year'] ?></b></small></p>
